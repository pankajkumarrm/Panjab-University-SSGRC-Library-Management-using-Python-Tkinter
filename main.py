...
cur = con.cursor()
root = Tk()
root.title("Panjab University SSGRC")
...
[imageSizeWidth, imageSizeHeight] = [8000, 3000]
...
Canvas1.config(bg="cyan", width=newImageSizeWidth, height=newImageSizeHeight)
Canvas1.pack(expand=True, fill=BOTH)
headingFrame1 = Frame(root, bg="White", bd=5)
headingFrame1.place(relx=0.2, rely=0.1, relwidth=0.6, relheight=0.16)
headingLabel = Label(headingFrame1, text="Welcome to \n Panjab University SSGRC Library",
                     bg='Red', fg='white', font=('Courier', 15))
...
btn6 = Button(root, text="View Issued Book List",
              bg='black', fg='white', command=View1)
